...
var EwtsConverter = /** @class */ (function () {
    ...
    EwtsConverter.initHashes = function () {
        var tmpSet;
        EwtsConverter.m_consonant = (new HashMap());
        ...
        EwtsConverter.m_subjoined = (new HashMap());
        ...
        EwtsConverter.m_vowel = (new HashMap());
        ...
        EwtsConverter.m_final_uni = (new HashMap());
        ...
        EwtsConverter.m_final_class = (new HashMap());
        ...
        EwtsConverter.m_final_class_$LI$().put("^", "^");
        EwtsConverter.m_final_class_$LI$().put("&", "&");
        EwtsConverter.m_other = (new HashMap());
        ...
        EwtsConverter.m_other_$LI$().put("$", "\u0f06");
        EwtsConverter.m_other_$LI$().put("%", "\u0f07");
        EwtsConverter.m_special = (new HashSet());
        ...
        EwtsConverter.m_special_$LI$().add("`");
        EwtsConverter.m_special_$LI$().add("]");
        EwtsConverter.m_superscripts = (new HashMap());
        tmpSet = (new HashSet());
        tmpSet.add("k");
        tmpSet.add("g");
        tmpSet.add("ng");
        ...
        EwtsConverter.m_subscripts = (new HashMap());
        tmpSet = (new HashSet());
        tmpSet.add("k");
        tmpSet.add("kh");
        tmpSet.add("g");
        ...
        EwtsConverter.m_prefixes = (new HashMap());
        tmpSet = (new HashSet());
        tmpSet.add("c");
        tmpSet.add("ny");
        tmpSet.add("t");
        ...
        EwtsConverter.m_suffixes = (new HashSet());
        ...
        EwtsConverter.m_suffixes_$LI$().add("-n");
        EwtsConverter.m_suffixes_$LI$().add("-t");
        EwtsConverter.m_suff2 = (new HashMap());
        tmpSet = (new HashSet());
        tmpSet.add("g");
        tmpSet.add("ng");
        tmpSet.add("b");
        ...
        EwtsConverter.m_affixedsuff2 = (new HashSet());
        EwtsConverter.m_affixedsuff2_$LI$().add("ng");
        EwtsConverter.m_affixedsuff2_$LI$().add("m");
        EwtsConverter.m_ambiguous_key = (new HashMap());
        ...
        EwtsConverter.m_ambiguous_wylie = (new HashMap());
        ...
        EwtsConverter.m_tib_top = (new HashMap());
        ...
        EwtsConverter.m_tib_subjoined = (new HashMap());
        ...
        EwtsConverter.m_tib_vowel = (new HashMap());
        ...
        EwtsConverter.m_tib_vowel_long = (new HashMap());
        EwtsConverter.m_tib_vowel_long_$LI$().put("i", "I");
        EwtsConverter.m_tib_vowel_long_$LI$().put("u", "U");
        EwtsConverter.m_tib_vowel_long_$LI$().put("-i", "-I");
        EwtsConverter.m_tib_final_wylie = (new HashMap());
        ...
        EwtsConverter.m_tib_final_class = (new HashMap());
        ...
        EwtsConverter.m_tib_other_$LI$().put('\u0f3c', "(");
        EwtsConverter.m_tib_other_$LI$().put('\u0f3d', ")");
        EwtsConverter.m_tib_stacks = (new HashSet());
        ...
        EwtsConverter.m_tokens_start = (new HashMap());
        ...
        EwtsConverter.m_tokens = (new HashSet());
    ...
    EwtsConverter.normalizeSloppyWylie = function (str) {
        str = StringUtils_1.StringUtils.replaceEach(str, EwtsConverter.base_$LI$(), EwtsConverter.repl_$LI$());
    ...
    EwtsConverter.prototype.toUnicode$java_lang_String$java_util_List$boolean = function (str, warns, sloppy) {
        ...
        if (this.mode === EwtsConverter.Mode.DWTS || this.mode === EwtsConverter.Mode.DTS) {
            str = TransConverter_1.TransConverter.dtsToEwts(str);
        }
        else if (this.mode === EwtsConverter.Mode.ALALC) {
            str = TransConverter_1.TransConverter.alalcToEwts(str);
        }
        if (this.fix_spacing) {
...
})(EwtsConverter = exports.EwtsConverter || (exports.EwtsConverter = {}));
exports.EwtsConverter = EwtsConverter;
EwtsConverter.__static_initialize();
var TransConverter_1 = require("./TransConverter");
var StringUtils_1 = require("./StringUtils");
//# sourceMappingURL=EwtsConverter.js.map